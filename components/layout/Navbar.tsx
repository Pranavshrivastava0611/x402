      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <MonoDropdown
              trigger={
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-white to-gray-400 flex items-center justify-center cursor-pointer hover:scale-105 transition-transform flex-shrink-0">
                  <User size={16} className="sm:w-[18px] sm:h-[18px] text-black" />
                </div>
              }
              align="right"
            >
              <div className="py-2">
                <Link
                  href="/dashboard/settings"
                  className="flex items-center gap-3 px-4 py-2 hover:bg-[#2A2A2A] transition-colors text-sm"
                >
                  <Settings size={16} />
                  <span>Settings</span>
                </Link>
                <button
                  onClick={onWalletDisconnect}
                  className="w-full flex items-center gap-3 px-4 py-2 hover:bg-[#2A2A2A] transition-colors text-red-400 text-sm"
                >
                  <LogOut size={16} />
                  <span>Sign Out</span>
                </button>
